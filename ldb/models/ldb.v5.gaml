...
global {
  ...
  // simulation control
  string parameter_name <- "../includes/parameters1.v5.json";
...
experiment main type: gui {
	parameter 'Fichier paramètre'  var: parameter_name category: 'Simulation' init: "../includes/parameters1.v5.json";
